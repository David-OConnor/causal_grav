...
pub fn ngc_2685() -> GalaxyDescrip {
    ...
    ].into_iter().map(|v| v * 10e6).collect(); // convert to M☉/kpc^2;
    ...
    let density_bulge_ = vec![
        29637.09388, 29637.09388, 29119.00646, 28546.91739, 27835.95108, 27114.68817, 26034.58429,
        25166.29367, 24000.76381, 22735.53888, 21385.99481, 19925.57520, 18449.90519, 17216.03165,
        15941.72231, 14650.03410, 13123.50973, 11364.50947, 9843.52233, 8492.69425, 7178.64917,
        5992.28305, 5128.05857, 4283.19400, 3667.81694, 2925.09072, 2275.31105, 1769.97708,
        1403.04449, 967.60125, 663.41545, 473.96446, 326.67018, 217.20846, 138.42412, 84.27460,
        48.85553, 26.88098, 13.90071, 6.73397, 3.03608, 1.26156, 0.48155, 0.16666, 0.05179, 0.01436,
        0.00349, 0.00074, 0.00014, 0.00002, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000,
...
pub fn ngc_2824() -> GalaxyDescrip {
    ...
    let radius = vec![
        ...
        5.15675, 5.67319, 6.23955, 6.86351, 7.55082, 8.30532, 9.13662, 10.05048, 11.05457, 12.16041,
        13.37760,
    ];
    ...
    let density_disk_ = vec![
        ...
        2055.79046, 1887.95677, 1665.83787, 1394.14145, 1191.40312, 1042.90608, 910.11888, 773.23372,
        633.74339, 495.12393, 370.43669, 268.85245, 192.62560, 147.33774, 114.89840, 96.36382,
        82.62548, 73.70789, 66.05626, 59.03560, 39.76619, 26.05637, 18.10982, 15.51365, 11.76830,
        10.51753, 8.11174, 6.36669, 4.49484, 4.44134,
    ].into_iter().map(|v| v * 10e6).collect(); // convert to M☉/kpc^2
    ...
    // At the disk radius indexies. M☉/pc^2
    let density_bulge_ = vec![
        19929.70080, 19929.70080, 19066.07962, 18169.49574, 17433.27344, 16491.24791, 15400.27144,
        14345.66756, 13132.79604, 11892.65755, 10478.35539, 8884.86077, 7311.13877, 5941.92075,
        4585.60688, 3315.97579, 2536.46001, 1730.24166, 1067.57138, 461.69833, 204.88269, 83.07041,
        30.77383, 10.41623, 3.07915, 0.83166, 0.19618, 0.03951, 0.00680, 0.00098, 0.00012, 0.00001,
        0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000, 0.00000,
    ...
    // km/s
    let velocity_bulge_ = vec![
        0.000000, 88.399177, 101.509195, 112.280335, 123.138977, 135.232161, 146.115845, 157.543821,
